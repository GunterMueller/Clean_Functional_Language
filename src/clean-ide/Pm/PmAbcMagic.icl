...
PatchSystemABC :: !Int !Bool !Pathname /*!Bool*/ !Bool !Bool !*Files -> (!Bool, !*Files)
PatchSystemABC version doPatch abcPath /*memoryProfile*/ timeProfile callgraphProfile files
	| not doPatch
		=	(True, files)
	# (opened, file, files)
...
where
	...
	patchLine line
		...
		| found
			# line = copy line
			//# line & [offset+NoMemoryProfileMask] = if memoryProfile '0' '1'
			# line & [offset+NoTimeProfileMask] = if timeProfile '0' '1'
			| offset+CallgraphProfileOffset < size line &&
					(line.[offset+CallgraphProfileOffset]=='0' || line.[offset+CallgraphProfileOffset]=='1')
				# line & [offset+CallgraphProfileOffset] = if callgraphProfile '1' '0'
				= (True, line)
				= (not callgraphProfile, line)
			=	(False, line)
